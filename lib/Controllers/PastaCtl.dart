...
class PastaCtrl{
  ...
  navPasta(BuildContext context, Paad pad, String caminho, String tarefa, List<IconInicial> listiconIni, int index) async {
    
    await showDialog(
      context: context,
      builder: (context) => Pops().popScren( NavPasta(pad: pad))).then((value) async {
